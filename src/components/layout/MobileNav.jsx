...
export default function MobileNav() {
  ...
  return (
    <div 
      className="md:hidden fixed bottom-2 left-1/2 -translate-x-1/2 w-[90%] max-w-[380px] z-40 bg-black/60 backdrop-blur-xl border border-white/10 py-3.5 px-6 flex items-center justify-between shadow-2xl rounded-full"
    >
      {navItems.map(item => {
