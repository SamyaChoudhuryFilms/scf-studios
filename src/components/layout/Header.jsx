      ...
      <div className="flex items-center gap-4">
        ...
        <form onSubmit={handleSearchSubmit} className="relative hidden md:block" ref={searchRef}>
          ...
          {showSuggestions && suggestions.length > 0 && (
            <div className="absolute right-0 mt-2 w-72 bg-card-bg/80 backdrop-blur-md border border-white/10 rounded-lg shadow-2xl p-2 z-50">
        ...
        <div className="relative hidden md:block" ref={notificationRef}>
          ...
          {showNotifications && (
            <div className="absolute right-0 mt-3 w-80 bg-card-bg/80 backdrop-blur-md border border-white/10 rounded-lg shadow-2xl overflow-hidden z-50 animate-slide-in">
        ...
        {activeProfile ? (
          <div className="relative" ref={dropdownRef}>
            ...
            {profileDropdownOpen && (
              <div className="absolute right-0 mt-3 w-56 bg-card-bg/80 backdrop-blur-md border border-white/10 rounded-lg shadow-2xl overflow-hidden z-50">
