...
export default function Header() {
  ...
  return (
    ...
    <div
      className={`fixed top-0 left-0 h-full w-[280px] z-[170] bg-bg-secondary border-r border-white/5 shadow-2xl transition-transform duration-300 md:hidden flex flex-col ${
